...
open class PulleyViewController: UIViewController, UIScrollViewDelegate, PulleyPassthroughScrollViewDelegate, UISearchBarDelegate {
    ...
    func centerMapByCurrentLocation(sender: UIBarButtonItem) {
        NotificationCenter.default.post(name: .centerMapByCurrentLocation, object: nil)
    }
    
    override open func viewDidLoad() {
        super.viewDidLoad()
        
        self.navigationController?.navigationBar.barTintColor = UIColor.init(netHex: 0xED1C40)
